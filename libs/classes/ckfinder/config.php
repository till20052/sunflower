...
$config['LicenseKey'] = $_SERVER['HTTP_HOST'];

switch($config['LicenseKey'])
{
	case "volya.ua":
		$config['LicenseKey'] = 'CQ0Q0000K00NY000000000000P0';
		$baseUrl = '/../apps/volya-v1/static/upload/';
		break;

	case "www.volya.ua":
		$config['LicenseKey'] = '2L0Q0000800LB000000000000N0';
		$baseUrl = '/../apps/volya-v1/static/upload/';
		break;
}
...
if( ! isset($baseUrl))
	$baseUrl = "/libs/classes/ckfinder/userfiles/";
...
$config['ResourceType'][] = Array(
		...
		'url' => "/upload",
		'directory' => substr($baseDir, 0, strlen($baseDir) - 1),
		'maxSize' => 0,
